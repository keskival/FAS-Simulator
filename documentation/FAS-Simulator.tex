...
If human eye can make out some structure in the sequence, then in principle it is possible for the automated algorithms to do so also.
...
\begin{figure}[tb]
 ...
 \caption{The event sequence as color pixels from left to right, top to botton}
