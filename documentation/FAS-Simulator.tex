...
For evaluation purposes, we will use a generated event sequence with first one complete sequence for one item only, then for 20 items simultaneously going through the system,
