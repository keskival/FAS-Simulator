...
For evaluating whether there is enough information in the sequence to determine some structure in the model, the sequence was visualized as colored pixels in Figure \ref{figure:color_vis}.
...
from an ordered color map, and the states are indexed in the order they are met in the log. It is possible to discern the production batches from the image. For each batch there are
