...
\usepackage{array}
\usepackage{url}
\hyphenation{op-tical net-works semi-conduc-tor method}
...
of the graph are in perfect, deterministic order. However, for multiple parallel items being processed it becomes evident that the previous event doesn't in itself
completely determine the next event. Some queuing is also visible in the later parts of the sequences.
