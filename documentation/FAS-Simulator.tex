...
If the process instances are known for log messages, the corresponding Petri Net model is considered ``colored''.
...
Deinterleaving the logs and mining the process instances for the log messages would simplify the model generators and models required for evaluating the allowed sequences.
