...
To have a meaningful simulation of a system under systemic faults we only need to simulate some representative fault conditions.

\begin{table}[!t]
\renewcommand{\arraystretch}{1.3}
\caption{Table of the simulated systemic failures}
...
to affect Iranian uranium enrichment centrifuges in a subtle way to causing the centrifuges to tear themselves apart.
