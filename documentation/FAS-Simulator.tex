...
simulations instead of real data. Real measured data is often limited in both state space and in volume, where simulations give better results \cite{duch2005artificial}.
