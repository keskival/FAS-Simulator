...
An LSTM model with an input layer of 77, two consequtive LSTM layers of 43 and 41 nodes and an output layer of 35 symbols softmaxed,
...
to determine validation set loss for parameter optimization.
