...
as the rare errors are forgotten and some faults might present in an unexpected manner\cite{camarinha1996integration}.
...
However, it is a reasonable configuration of such a simple production system.
...
The simulation will not be fully deterministic and contains soft faults which do not immediately affect operation in addition to hard faults which result in immediate downtime.
...
by scheduling failure activation as separate non-logged events.
The main execution sets up the configuration of the processes, and bootstraps the events and optional failures.
...
Each step contains several events and associated log messages. The log messages include the component which logged the event, but not the process instance.
...
\begin{subfigure}[h]{0.5\linewidth}
 \includegraphics[width=7 cm,keepaspectratio=true]{./failure_profile.eps}
 \caption{A delay profile of continuous wear and tear}
 \label{figure:continuouswearandtear}
\end{subfigure}
\begin{subfigure}[h]{0.5\linewidth}
 \includegraphics[width=7 cm,keepaspectratio=true]{./retry_profile.eps}
...
\begin{figure}[tb]
\begin{subfigure}[h]{0.5\linewidth}
 \includegraphics[width=7 cm,keepaspectratio=true]{./representative_log.eps}
 \caption{A representative log of event types graphed against time index}
 \label{figure:events}
\end{subfigure}
\begin{subfigure}[h]{0.5\linewidth}
 \includegraphics[width=7 cm,keepaspectratio=true]{./detail.eps}
