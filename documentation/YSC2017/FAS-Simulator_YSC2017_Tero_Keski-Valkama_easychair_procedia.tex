...
\begin{subfigure}[h]{0.5\linewidth}
 \resizebox{0.95\linewidth}{!}{\input{./failure_profile.tex}}
 \caption{A delay profile of continuous wear and tear}
 \label{figure:continuouswearandtear}
\end{subfigure}
\begin{subfigure}[h]{0.5\linewidth}
 \resizebox{0.95\linewidth}{!}{\input{./retry_profile.tex}}
...
\begin{subfigure}[h]{0.4\linewidth}
 \resizebox{0.95\linewidth}{!}{\input{./output_easy.tex}}
...
\end{subfigure}
\begin{subfigure}[h]{0.4\linewidth}
 \resizebox{0.95\linewidth}{!}{\input{./output_easy_with_wear_and_tear_fault.tex}}
...
\end{subfigure}
\begin{subfigure}[h]{0.4\linewidth}
 \resizebox{0.95\linewidth}{!}{\input{./output_easy_with_retry_delay_fault.tex}}
