...
The pixel colors correspond to event types and are chosen from a ``copper'' color map. The end is padded with gray.
...
\end{subfigure}
 \caption{The event sequence as colored pixels from left to right, top to bottom, padded in the end with gray.}
