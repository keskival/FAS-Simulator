...
Mathematically, the logs generated by the FAS Simulator can be described as a set of sequences each describing a successful assembly of one product instance shuffled, or interleaved
together.
