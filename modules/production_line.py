...
class ProductionLine:
    def __init__(self, env, logger):
        ...
        self.conveyor5 = Conveyor("CONVEYOR5", 30000, logger, env)
        self.bowl3 = BowlFeeder("BOWL3", 5000, logger, env)
        self.conveyor6 = Conveyor("CONVEYOR6", 10000, logger, env)
        self.manual_add_cover_and_bolts = ManualStep("MANUAL_ADD_COVER_AND_BOLTS", 76000, logger, env)
        self.conveyor7 = Conveyor("CONVEYOR7", 30000, logger, env)
        ...
        self.conveyor9 = Conveyor("CONVEYOR9", 21000, logger, env)
        self.manual_tighten_bolts2 = ManualStep("MANUAL_TIGHTEN_BOLTS2", 16000, logger, env)
        self.conveyor10 = Conveyor("CONVEYOR10", 21000, logger, env)
